 ...
 * @author Thisura
 */
public class OPD_Patient extends Patient {
 

    private final String wardNo = "";

    public OPD_Patient( JTextField C_fName_tBox, JTextField C_lName_tBox, JTextField C_age_tbox, JComboBox C_genderSelection, JTextField C_NICNo_tBox,
    ...
    public void insertToTable(JTable C_PatientTable_view, JLabel C_patient_id_label){
        ...
        this.getValues();
            ...
            try {            
              ...
              //object creation
            Patient_Creation_View AdIn = new Patient_Creation_View();//object creation
